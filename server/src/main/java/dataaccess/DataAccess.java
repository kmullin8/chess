...
public interface DataAccess {
     ...
     */
    UserModel writeUser(UserModel user) throws DataAccessException;
     ...
     * @throws DataAccessException for database or sql query violations (e.g. no error for not found).
     */
    UserModel readUser(String userName) throws DataAccessException;
     ...
     * @throws DataAccessException for database or sql query violations.
     */
    AuthTokenModel writeAuth(String username) throws DataAccessException;
     ...
     * @throws DataAccessException for database or sql query violations (e.g. no error for not found).
     */
    AuthTokenModel readAuth(String authToken) throws DataAccessException;
     ...
     * @throws DataAccessException for database or sql query violations.
     */
    GameModel newGame(String gameName) throws DataAccessException;
     ...
     * @throws DataAccessException for database or sql query violations (e.g. no error for not found).
     */
    GameModel readGame(int gameID) throws DataAccessException;
